...
PATTERNS = (
    ...
    ("colour.literal.wx", "high", re.compile(r"\bwx\.Colour\(")),
    ("colour.named", "high", re.compile(r"(?:SetBackgroundColour|SetForegroundColour)\(\s*[\"'](?:RED|PINK|BLUE|GREEN|YELLOW|GREY|GRAY|WHITE|BLACK)[\"']", re.IGNORECASE)),
    ("typography.manual_font", "medium", re.compile(r"\.SetFont\(")),
    ("typography.literal_font", "medium", re.compile(r"\bwx\.Font\(")),
    ("typography.literal_points", "medium", re.compile(r"\.SetPointSize\(\s*\d+\s*\)")),
