...
class Dialog(wx.Dialog):
    def __init__(self, parent, title="" , IDtype=0):
        ...
        self.label_nom_abrege = wx.StaticText(self.sizer_contenu_staticbox, -1, _(u"Nom abrégé :"))
        self.text_nom_abrege = wx.TextCtrl(self.sizer_contenu_staticbox, -1, "")
        self.label_nom_abrege_aide = wx.StaticText(self.sizer_contenu_staticbox, -1, "(5 lettres maximum)")
        self.label_nom = wx.StaticText(self.sizer_contenu_staticbox, -1, "Nom complet :")
        self.text_nom = wx.TextCtrl(self.sizer_contenu_staticbox, -1, "")
        self.label_duree = wx.StaticText(self.sizer_contenu_staticbox, -1, _(u"A durée \nindéterminée ?"), style=wx.ALIGN_RIGHT)
        self.radio_oui = wx.RadioButton(self.sizer_contenu_staticbox, -1, "Oui", style=wx.RB_GROUP)
        self.radio_non = wx.RadioButton(self.sizer_contenu_staticbox, -1, "Non")
