...
class Dialog(wx.Dialog):
    def __init__(self, parent, ID=-1, title=_(u"Saisie d'un type de pièce"), IDtype_piece=0):
        ...
        self.text_nom = wx.TextCtrl(self.sizer_nom_staticbox, -1, "")
        self.radio_duree_1 = wx.RadioButton(self.sizer_duree_staticbox, -1, _(u"Validité illimitée"), style=wx.RB_GROUP)
        self.radio_duree_2 = wx.RadioButton(self.sizer_duree_staticbox, -1, _(u"Validité limitée : "))
        self.label_jours = wx.StaticText(self.sizer_duree_staticbox, -1, "Jours :")
        self.spin_jours = wx.SpinCtrl(self.sizer_duree_staticbox, -1, "", min=0, max=100)
        self.label_mois = wx.StaticText(self.sizer_duree_staticbox, -1, "Mois :")
        self.spin_mois = wx.SpinCtrl(self.sizer_duree_staticbox, -1, "", min=0, max=100)
        self.label_annees = wx.StaticText(self.sizer_duree_staticbox, -1, _(u"Années :"))
        self.spin_annees = wx.SpinCtrl(self.sizer_duree_staticbox, -1, "", min=0, max=100)
        self.radio_diplomes_1 = wx.RadioButton(self.sizer_diplomes_staticbox, -1, _(u"Pour tous les employés"), style=wx.RB_GROUP)
        self.radio_diplomes_2 = wx.RadioButton(self.sizer_diplomes_staticbox, -1, _(u"Pour les employés possédant la ou les qualifications suivantes :"))
        
        #self.list_diplomes = wx.ListCtrl(self.panel_base, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER)
        self.ImportationDiplomes()
        self.list_diplomes = wx.CheckListBox(self.sizer_diplomes_staticbox, -1, choices=self.ListeDiplomesPourLBox)
        # ----------------------------------------------------------------------------------------------
