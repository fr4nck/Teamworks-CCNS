...
class MyDialog(wx.Dialog):
    def __init__(self, parent, adresse=None):
        ...
        self.radio_predefini = wx.RadioButton(self.static_sizer_serveur_staticbox, -1, "")
        self.label_predefini = wx.StaticText(self.static_sizer_serveur_staticbox, -1, _(u"Serveur prédéfini :"))
        self.ctrl_predefinis = wx.Choice(self.static_sizer_serveur_staticbox, -1, choices=listeServeursChoices)
        self.radio_personnalise = wx.RadioButton(self.static_sizer_serveur_staticbox, -1, "")
        self.label_personnalise = wx.StaticText(self.static_sizer_serveur_staticbox, -1, _(u"Serveur personnalisé :"))
        self.label_smtp = wx.StaticText(self.static_sizer_serveur_staticbox, -1, _(u"Serveur SMTP :"))
        self.ctrl_smtp = wx.TextCtrl(self.static_sizer_serveur_staticbox, -1, "")
        self.label_port = wx.StaticText(self.static_sizer_serveur_staticbox, -1, _(u"Numéro de port :"))
        self.ctrl_port = wx.TextCtrl(self.static_sizer_serveur_staticbox, -1, "")
        self.label_ssl = wx.StaticText(self.static_sizer_serveur_staticbox, -1, _(u"Connexion SSL :"))
        self.ctrl_ssl = wx.CheckBox(self.static_sizer_serveur_staticbox, -1, "")
        self.label_adresse = wx.StaticText(self.static_sizer_adresse_staticbox, -1, _(u"Adresse :"))
        self.ctrl_adresse = wx.TextCtrl(self.static_sizer_adresse_staticbox, -1, "")
        self.label_mdp = wx.StaticText(self.static_sizer_adresse_staticbox, -1, _(u"Mot de passe :"))
        self.ctrl_mdp = wx.TextCtrl(self.static_sizer_adresse_staticbox, -1, "")
