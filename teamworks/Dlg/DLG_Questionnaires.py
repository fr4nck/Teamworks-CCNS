...
class Dialog(wx.Dialog):
    def __init__(self, parent, type="individu"):
        ...
        self.bouton_ajouter = CTRL_Bouton_image.CTRL(self.box_questionnaire_staticbox, id=-1, texte="", cheminImage=Chemins.GetStaticPath("Images/16x16/Ajouter.png"))
        self.bouton_modifier = CTRL_Bouton_image.CTRL(self.box_questionnaire_staticbox, id=-1, texte="", cheminImage=Chemins.GetStaticPath("Images/16x16/Modifier.png"))
        self.bouton_supprimer = CTRL_Bouton_image.CTRL(self.box_questionnaire_staticbox, id=-1, texte="", cheminImage=Chemins.GetStaticPath("Images/16x16/Supprimer.png"))
        self.bouton_monter = CTRL_Bouton_image.CTRL(self.box_questionnaire_staticbox, id=-1, texte="", cheminImage=Chemins.GetStaticPath("Images/16x16/Fleche_haut.png"))
        self.bouton_descendre = CTRL_Bouton_image.CTRL(self.box_questionnaire_staticbox, id=-1, texte="", cheminImage=Chemins.GetStaticPath("Images/16x16/Fleche_bas.png"))
