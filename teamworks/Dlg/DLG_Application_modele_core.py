...
class Panel(wx.Panel):
    def __init__(self, parent, selectionLignes=None, selectionPersonnes=None, selectionDates=(None, None) ):
        ...
        self.radio_btn_1 = wx.RadioButton(self.sizer_parametres_staticbox, -1, u"")
        self.radio_btn_2 = wx.RadioButton(self.sizer_parametres_staticbox, -1, _(u"Selon les paramètres suivants :"))
        self.label_periode = wx.StaticText(self.sizer_parametres_staticbox, -1, _(u"Période du :"))
        self.date_debut = DatePickerCtrl(self.sizer_parametres_staticbox, -1, style=DP_DROPDOWN)
        self.label_au = wx.StaticText(self.sizer_parametres_staticbox, -1, "au")
        self.date_fin = DatePickerCtrl(self.sizer_parametres_staticbox, -1, style=DP_DROPDOWN)
        self.label_personnes = wx.StaticText(self.sizer_parametres_staticbox, -1, "Personnes :")
        self.list_ctrl_personnes = listCtrl_Personnes(self.sizer_parametres_staticbox)
