...
class Dialog(wx.Dialog):
    def __init__(self, parent, title="" , IDferie=0, type=""):
        ...
        self.label_nom = wx.StaticText(self.staticBox_staticbox, -1, "Nom :")
        self.text_ctrl_nom = wx.TextCtrl(self.staticBox_staticbox, -1, "")
        self.label_jour_fixe = wx.StaticText(self.staticBox_staticbox, -1, "Jour :")
        choices=[]
        for x in range(1, 32) : choices.append(str(x))
        self.choice_jour_fixe = wx.Choice(self.staticBox_staticbox, -1, choices=choices)
        self.label_mois_fixe = wx.StaticText(self.staticBox_staticbox, -1, "Mois :")
        self.choice_mois_fixe = wx.Choice(self.staticBox_staticbox, -1, choices=["Janvier", _(u"Février"), "Mars", "Avril", "Mai", "Juin", "Juillet", _(u"Août"), "Septembre", "Octobre", "Novembre", _(u"Décembre")])
        self.label_date_variable = wx.StaticText(self.staticBox_staticbox, -1, "Date :")
        self.datepicker_date_variable = DatePickerCtrl(self.staticBox_staticbox, -1, style=DP_DROPDOWN)
