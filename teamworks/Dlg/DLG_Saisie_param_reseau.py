...
class Dialog(wx.Dialog):
    def __init__(self, parent, intro=None):
        ...
        content_parent = self.box_contenu_staticbox
        self.label_intro = wx.StaticText(self, -1, intro)
        self.label_port = wx.StaticText(content_parent, -1, _(u"Port :"))
        self.ctrl_port = wx.TextCtrl(content_parent, -1, u"3306")
        self.label_hote = wx.StaticText(content_parent, -1, _(u"Hôte :"))
        self.ctrl_hote = wx.TextCtrl(content_parent, -1, u"")
        self.label_utilisateur = wx.StaticText(content_parent, -1, _(u"Utilisateur :"))
        self.ctrl_utilisateur = wx.TextCtrl(content_parent, -1, u"")
        self.label_mdp = wx.StaticText(content_parent, -1, _(u"Mot de passe :"))
        self.ctrl_mdp = wx.TextCtrl(content_parent, -1, u"", style=wx.TE_PASSWORD)
...
def TestConnexion(dictValeurs=None):
