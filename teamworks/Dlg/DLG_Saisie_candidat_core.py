...
class Panel(wx.Panel):
    def __init__(self, parent, IDcandidat=None):
        ...
        self.label_civilite = wx.StaticText(self.sizer_identite_staticbox, -1, _(u"Civilité :"))
        self.ctrl_civilite = wx.Choice(self.sizer_identite_staticbox, -1, choices=[_(u"Mr"), _(u"Melle"), _(u"Mme")])
        self.label_nom = wx.StaticText(self.sizer_identite_staticbox, -1, _(u"Nom :"))
        self.ctrl_nom = wx.TextCtrl(self.sizer_identite_staticbox, -1, u"")
        self.label_prenom = wx.StaticText(self.sizer_identite_staticbox, -1, _(u"Prénom :"))
        ...
        self.ctrl_age_2 = wx.TextCtrl(self.sizer_identite_staticbox, -1, "", style=wx.TE_CENTRE, size=(30,-1))
        self.label_ans = wx.StaticText(self.sizer_identite_staticbox, -1, _(u"ans"))
        ...
        self.ctrl_memo = wx.TextCtrl(self.sizer_memo_staticbox, -1, u"", style=wx.TE_MULTILINE)
