...
class Dialog(wx.Dialog):
    def __init__(self, parent, title="" , IDchamp=0):
        ...
        self.label_nom = wx.StaticText(self.sizer_contenu_staticbox, -1, "Nom du champ :")
        self.text_nom = wx.TextCtrl(self.sizer_contenu_staticbox, -1, "")
        self.label_description = wx.StaticText(self.sizer_contenu_staticbox, -1, "Description :")
        self.text_description = wx.TextCtrl(self.sizer_contenu_staticbox, -1, "", style=wx.TE_MULTILINE)
        self.label_defaut = wx.StaticText(self.sizer_contenu_staticbox, -1, _(u"Valeur par défaut :"))
        self.text_defaut = wx.TextCtrl(self.sizer_contenu_staticbox, -1, "")
        self.label_exemple = wx.StaticText(self.sizer_contenu_staticbox, -1, _(u"Exemples de valeur :"))
        self.text_exemple = wx.TextCtrl(self.sizer_contenu_staticbox, -1, "")
        self.label_motCle = wx.StaticText(self.sizer_contenu_staticbox, -1, _(u"Mot-clé :"))
        self.text_motCle = wx.TextCtrl(self.sizer_contenu_staticbox, -1, "")
        self.label_motCle_aide = wx.StaticText(self.sizer_contenu_staticbox, -1, "(En majuscules et sans espaces)")
