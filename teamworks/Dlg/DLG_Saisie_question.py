...
class Dialog(wx.Dialog):
    def __init__(self, parent, type="individu", IDquestion=None):
        ...
        self.label_label = wx.StaticText(self.box_generalites_staticbox, -1, _(u"Label :"))
        self.ctrl_label = wx.TextCtrl(self.box_generalites_staticbox, -1, u"")
        self.label_categorie = wx.StaticText(self.box_generalites_staticbox, -1, _(u"Catégorie :"))
        self.ctrl_categorie = CTRL_Categorie(self.box_generalites_staticbox, type=type)
        self.label_controle = wx.StaticText(self.box_generalites_staticbox, -1, _(u"Contrôle :"))
        self.ctrl_controle = CTRL_Controle(self.box_generalites_staticbox)
        self.label_visible = wx.StaticText(self.box_generalites_staticbox, -1, _(u"Visible :"))
        self.ctrl_visible = wx.CheckBox(self.box_generalites_staticbox, -1, u"")
        self.ctrl_visible.SetValue(True) 
        
        # Apercu
        self.box_apercu_staticbox = wx.StaticBox(self, -1, _(u"Valeurs par defaut"))
        self.ctrl_apercu = CTRL_Questionnaire.CTRL(self.box_apercu_staticbox, type=type, mode="apercu", afficherInvisibles=True, largeurQuestion=0)
        ...
        self.label_hauteur = wx.StaticText(self.box_options_staticbox, -1, _(u"Hauteur du contrôle :"))
        self.ctrl_hauteur = wx.SpinCtrl(self.box_options_staticbox, -1, "")
        self.ctrl_hauteur.SetRange(-1, 500)
        self.label_valmin = wx.StaticText(self.box_options_staticbox, -1, _(u"Valeur minimale :"))
        self.ctrl_valmin = wx.SpinCtrl(self.box_options_staticbox, -1, "")
        self.ctrl_valmin.SetRange(0, 500)
        self.label_valmax = wx.StaticText(self.box_options_staticbox, -1, _(u"Valeur maximale :"))
        self.ctrl_valmax = wx.SpinCtrl(self.box_options_staticbox, -1, "")
