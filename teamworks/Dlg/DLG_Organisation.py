...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        super().__init__(parent, title="Structure / Association", size=(860, 700))
    ...
    def _build_identity_page(self, parent):
        ...
        self._row(page, grid, "Nom officiel :", "nom_officiel")
        self._row(page, grid, "Nom d’usage :", "nom_usage")
        self._row(page, grid, "Représentant légal :", "representant_legal")
        self._row(page, grid, "Fonction :", "representant_fonction")
        ...
        self._row(page, contact_grid, "Adresse :", "adresse")
        self._row(page, contact_grid, "Code postal :", "code_postal")
        self._row(page, contact_grid, "Ville :", "ville")
        self._row(page, contact_grid, "Téléphone :", "telephone")
        self._row(page, contact_grid, "Email :", "email")
        self._row(page, contact_grid, "Site web :", "site_web")
        ...
        remove = wx.Button(page, label="Retirer")
        logo_row.Add(remove, 0)
        logo_box.Add(logo_row, 0, wx.EXPAND | wx.ALL, 10)
        hint = wx.StaticText(
            page,
            label="PNG transparent recommandé. Ce logo sera réutilisé dans le splash, l’accueil et les documents.",
        )
    ...
    def _build_legal_page(self, parent):
        ...
        self._row(page, legal_grid, "RNA / n° association :", "rna")
        self._row(page, legal_grid, "SIREN :", "siren")
        self._row(page, legal_grid, "SIRET :", "siret")
        self._row(page, legal_grid, "Code APE / NAF :", "ape_naf")
        self._row(page, legal_grid, "Préfecture / déclaration :", "declaration_prefecture")
        self._row(page, legal_grid, "Référence JOAFE :", "reference_joafe")
        ...
        self._row(page, approval_grid, "Agrément Jeunesse et Sports / JEP :", "agrement_js")
        self._row(page, approval_grid, "Date / validité :", "agrement_js_date")
        ...
        self._row(page, insurance_grid, "Assureur :", "assureur")
        self._row(page, insurance_grid, "N° de police :", "police_assurance")
        self._row(page, insurance_grid, "Échéance / validité :", "assurance_echeance")
    ...
    def _build_documents_page(self, parent):
        ...
        for key, label in labels:
            ctrl = wx.CheckBox(page, label=label)
        ...
        self.preview = wx.TextCtrl(page, style=wx.TE_MULTILINE | wx.TE_READONLY, size=(-1, 150))
