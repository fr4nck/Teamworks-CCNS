...
class Dialog(wx.Dialog):
    def __init__(self, parent, title="" , IDvaleur=0):
        ...
        self.label_valeur = wx.StaticText(self.sizer_contenu_staticbox, -1, _(u"Valeur :"))
        self.text_valeur = wx.TextCtrl(self.sizer_contenu_staticbox, -1, "", style=wx.TE_CENTRE)
        self.label_euro = wx.StaticText(self.sizer_contenu_staticbox, -1, u"€")
        self.label_dateDebut = wx.StaticText(self.sizer_contenu_staticbox, -1, _(u"A partir du :"))
        self.datepicker_dateDebut = DatePickerCtrl(self.sizer_contenu_staticbox, -1, style=DP_DROPDOWN)
