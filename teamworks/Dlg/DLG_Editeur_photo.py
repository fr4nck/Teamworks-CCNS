...
class ImgBox(wx.Window):
    ...
    def InitImage(self):
        ...
        if isinstance(self.fichierImageSource, str) :
...
class Dialog(wx.Dialog):
    def __init__(self, parent, image=None, tailleCadre=(384, 384), titre=_(u"Editeur photo")):
        ...
        self.img_loupe_plus = wx.StaticBitmap(self.staticBox_zoom, -1, wx.Bitmap(Chemins.GetStaticPath("Images/22x22/ZoomPlus.png"), wx.BITMAP_TYPE_ANY))
        self.img_loupe_moins = wx.StaticBitmap(self.staticBox_zoom, -1, wx.Bitmap(Chemins.GetStaticPath("Images/22x22/ZoomMoins.png"), wx.BITMAP_TYPE_ANY))
        
        self.staticBox_decoration = wx.StaticBox(self, -1, _(u"Cadre de décoration"))
        listeCadres = FonctionsPerso.GetListeCadresPhotos()
        self.combobox_decoration = wx.Choice(self.staticBox_decoration, -1, choices=listeCadres)
