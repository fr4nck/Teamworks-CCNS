...
class Panel(wx.Panel):
    def __init__(self, parent, IDemploi=None):
        ...
        self.label_date_debut = wx.StaticText(self.sizer_generalites_staticbox, -1, _(u"Lancement :"))
        self.ctrl_date_debut = DatePickerCtrl(self.sizer_generalites_staticbox, -1, style=DP_DROPDOWN)
        self.label_date_fin = wx.StaticText(self.sizer_generalites_staticbox, -1, _(u"Clôture :"))
        self.ctrl_date_fin = DatePickerCtrl(self.sizer_generalites_staticbox, -1, style=DP_DROPDOWN)
        self.label_intitule = wx.StaticText(self.sizer_generalites_staticbox, -1, _(u"Intitulé :"))
        self.ctrl_intitule = wx.TextCtrl(self.sizer_generalites_staticbox, -1, "")
        self.label_detail = wx.StaticText(self.sizer_generalites_staticbox, -1, _(u"Détail :"))
        self.ctrl_detail = wx.TextCtrl(self.sizer_generalites_staticbox, -1, "", style=wx.TE_MULTILINE)
        self.ctrl_detail.SetMinSize((-1, 100))
        self.label_reference = wx.StaticText(self.sizer_generalites_staticbox, -1, _(u"N° ANPE :"))
        self.ctrl_reference = wx.TextCtrl(self.sizer_generalites_staticbox, -1, "")
        ...
        self.label_diffuseurs = wx.StaticText(self.sizer_diffusion_staticbox, -1, _(u"  Diffuseurs :"))
