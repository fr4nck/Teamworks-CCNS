...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDmodele=0):
        ...
        self.label_nom = wx.StaticText(self.sizer_param_staticbox, -1, _(u"Nom :"))
        self.text_nom = wx.TextCtrl(self.sizer_param_staticbox, -1, self.nom)
        self.label_type = wx.StaticText(self.sizer_param_staticbox, -1, "Type :")
        self.radio_type_1 = wx.RadioButton(self.sizer_param_staticbox, -1, "Journalier", style=wx.RB_GROUP)
        self.radio_type_2 = wx.RadioButton(self.sizer_param_staticbox, -1, "Hebdomadaire")
        self.label_description = wx.StaticText(self.sizer_param_staticbox, -1, "Description :")
        self.text_description = wx.TextCtrl(self.sizer_param_staticbox, -1, self.description, style=wx.TE_MULTILINE)
        self.label_periodes = wx.StaticText(self.sizer_param_staticbox, -1, _(u"Périodes :"))
        self.checkbox_periodes_1 = wx.CheckBox(self.sizer_param_staticbox, -1, "Toutes")
        self.checkbox_periodes_2 = wx.CheckBox(self.sizer_param_staticbox, -1, _(u"Périodes scolaires"))
        self.checkbox_periodes_3 = wx.CheckBox(self.sizer_param_staticbox, -1, "Vacances scolaires")
        self.tree_planning = TreeCtrlPlanning(self.sizer_planning_staticbox)
        self.checkbox_inclureferies = wx.CheckBox(self.sizer_planning_staticbox, -1, _(u"Inclure les jours fériés"))
        self.checkbox_inclureferies.SetValue(self.inclureFeries)
        self.bouton_ajouter = wx.BitmapButton(self.sizer_planning_staticbox, -1, wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Ajouter.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_modifier = wx.BitmapButton(self.sizer_planning_staticbox, -1, wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Modifier.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_supprimer = wx.BitmapButton(self.sizer_planning_staticbox, -1, wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Supprimer.png"), wx.BITMAP_TYPE_ANY))
