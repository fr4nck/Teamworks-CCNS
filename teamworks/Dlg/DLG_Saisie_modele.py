...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDmodele=0):
        ...
        self.bouton_ajouter = CTRL_Bouton_image.CTRL(self.sizer_planning_staticbox, id=-1, texte="", cheminImage=Chemins.GetStaticPath("Images/16x16/Ajouter.png"))
        self.bouton_modifier = CTRL_Bouton_image.CTRL(self.sizer_planning_staticbox, id=-1, texte="", cheminImage=Chemins.GetStaticPath("Images/16x16/Modifier.png"))
        self.bouton_supprimer = CTRL_Bouton_image.CTRL(self.sizer_planning_staticbox, id=-1, texte="", cheminImage=Chemins.GetStaticPath("Images/16x16/Supprimer.png"))
