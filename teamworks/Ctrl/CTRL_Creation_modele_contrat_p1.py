...
class Page(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.bouton_type = CTRL_Bouton_image.Compact(self.sizer_caract_staticbox, texte="...")
        ...
        self.bouton_class = CTRL_Bouton_image.Compact(self.sizer_caract_staticbox, texte="...")
