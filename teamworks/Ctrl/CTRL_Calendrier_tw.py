...
class Calendrier(wx.ScrolledWindow):
    ...
    def DrawCase(self, dc, texteDate, x, y, l, h, survol=False):
        ...
        if texteDate == datetime.date.today() :
            ...
            dc.DrawRectangle(int(x+l-7), int(y+2), 4, 4)
    ...
    def OnContextMenu(self, nomCase):
        ...
        if texteDate != None :
            ...
            if select == False :
                texte = _(u"S�lectionner le ") + six.text_type(texteDate.day) + "/" + six.text_type(texteDate.month) + "/" + six.text_type(texteDate.year)
            else:
                texte = _(u"D�s�lectionner le ") + six.text_type(texteDate.day) + "/" + six.text_type(texteDate.month) + "/" + six.text_type(texteDate.year)
...
class CTRL_Annee(wx.SpinCtrl):
    def __init__(self, parent):
        ...
        self.SetToolTip(wx.ToolTip(_(u"S�lectionnez une ann�e")))
...
class Panel(wx.Panel):
    ...
    def OnBoutonAnnuel(self, event) :
        if self.calendrier.GetTypeCalendrier() == "mensuel" :
            ...
            # l'appel vient de la saisie des pr�sences de la fiche individuelle
            ...
            # l'appel vient de la frame d'application des Mod�les de pr�sences de la fiche individuelle
