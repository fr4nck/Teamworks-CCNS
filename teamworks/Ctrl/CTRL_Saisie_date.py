    ...
    def OnContextMenu(self, event):
        ...
        for id, label in listeFonctions :
            if id == None :
                ...
                item = menuPop.AppendSubMenu(sousMenu, label)
...
class Date2(wx.Panel):
    ...
    def __init__(self, parent, date_min="01/01/1910", date_max="01/01/2030", activeCallback=True, size=(-1, -1), heure=False, pos=wx.DefaultPosition):
        ...
        self.bouton_calendrier = wx.BitmapButton(self, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Calendrier.png"), wx.BITMAP_TYPE_ANY))  # native-button-ok: déclencheur compact intégré au champ date
