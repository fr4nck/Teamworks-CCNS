...
class Page(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.label_class = wx.StaticText(self.sizer_caract_staticbox, -1, "Classification :")
        ...
        self.label_valpoint = wx.StaticText(self.sizer_caract_staticbox, -1, "Valeur du point :")
        self.choice_valpoint = wx.Choice(self.sizer_caract_staticbox, -1, choices=[])
        self.Importation_valPoint()
        self.bouton_valpoint = wx.Button(self.sizer_caract_staticbox, -1, "...", style=wx.BU_EXACTFIT)
        
        self.label_date_debut = wx.StaticText(self.sizer_dates_staticbox, -1, "       A partir du :")
        self.datepicker_date_debut = DatePickerCtrl(self.sizer_dates_staticbox, -1, style=DP_DROPDOWN)
        self.label_date_fin = wx.StaticText(self.sizer_dates_staticbox, -1, "Jusqu'au :")
        self.datepicker_date_fin = DatePickerCtrl(self.sizer_dates_staticbox, -1, style=DP_DROPDOWN)
        self.datepicker_date_debut.Enable(False)
        self.datepicker_date_fin.Enable(False)
        
        self.check_rupture = wx.CheckBox(self.sizer_dates_staticbox, -1, _(u" Rupture anticipée du contrat au :"))
        self.datepicker_rupture = DatePickerCtrl(self.sizer_dates_staticbox, -1, style=DP_DROPDOWN)
        self.datepicker_rupture.Enable(False)
        
        self.label_essai = wx.StaticText(self.sizer_essai_staticbox, -1, _(u"    Nbre de jours :"))
        self.periode_essai = wx.SpinCtrl(self.sizer_essai_staticbox, -1, "", size=(60, -1))
        self.periode_essai.SetRange(0,99)
        self.periode_essai.SetValue(0)
        self.aide_essai = wx.StaticText(self.sizer_essai_staticbox, -1, _(u"  (1 jour par semaine travaillée)"))
