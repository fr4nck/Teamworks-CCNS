...
GROSS_ANNUAL_SALARY_COLUMN = "gross_annual_salary"
GROSS_ANNUAL_SALARY_TYPE = "REAL"
OPERATION_TYPE_COLUMN = "operation_type"
OPERATION_TYPE_TYPE = "VARCHAR(24)"
PREVIOUS_CONTRACT_ID_COLUMN = "previous_contract_id"
PREVIOUS_CONTRACT_ID_TYPE = "INTEGER"
TRIAL_PERIOD_VALUE_COLUMN = "trial_period_value"
TRIAL_PERIOD_VALUE_TYPE = "INTEGER"
TRIAL_PERIOD_UNIT_COLUMN = "trial_period_unit"
TRIAL_PERIOD_UNIT_TYPE = "VARCHAR(8)"
...
ADDITIVE_COLUMNS = (
    ...
    (GROSS_ANNUAL_SALARY_COLUMN, GROSS_ANNUAL_SALARY_TYPE),
    (OPERATION_TYPE_COLUMN, OPERATION_TYPE_TYPE),
    (PREVIOUS_CONTRACT_ID_COLUMN, PREVIOUS_CONTRACT_ID_TYPE),
    (TRIAL_PERIOD_VALUE_COLUMN, TRIAL_PERIOD_VALUE_TYPE),
    (TRIAL_PERIOD_UNIT_COLUMN, TRIAL_PERIOD_UNIT_TYPE),
)
