...
def _employee_values(legacy_values):
    return {
        ...
        "code_postal_naissance": legacy_values.get("CPNAISS", ""),
        "ville_naissance": legacy_values.get("VILLENAISS", ""),
        "numero_securite_sociale": legacy_values.get("NUMSECU", ""),
...
def _contract_values(legacy_values):
    return {
        ...
        "duree_essai_jours": legacy_values.get("ESSAI", ""),
        "valeur_point": legacy_values.get("VALEURPOINT", ""),
