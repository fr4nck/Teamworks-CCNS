...
DEFAULT_DOCUMENT_FIELD_REGISTRY = MergeFieldRegistry((
    ...
    _rh_field("SALARIE_CODE_POSTAL_NAISSANCE", "Code postal de naissance", "salarie", "rh.employee.birth_postal_code", aliases=("CPNAISS",), contexts=_EMPLOYEE),
    _rh_field("SALARIE_VILLE_NAISSANCE", "Ville de naissance", "salarie", "rh.employee.birth_city", aliases=("VILLENAISS",), contexts=_EMPLOYEE),
    _rh_field("SALARIE_NUMERO_SECURITE_SOCIALE", "Numéro de sécurité sociale", "salarie", "rh.employee.social_security_number", aliases=("NUMSECU",), contexts=_EMPLOYEE),
    ...
    _rh_field("CONTRAT_DUREE_ESSAI_JOURS", "Durée de la période d'essai (jours)", "contrat", "rh.contract.trial_period_days", aliases=("ESSAI",), contexts=_CONTRACT, value_type=FieldValueType.NUMBER),
    _rh_field("CONTRAT_VALEUR_POINT", "Valeur du point", "contrat", "rh.contract.point_value", aliases=("VALEURPOINT",), contexts=_CONTRACT, value_type=FieldValueType.NUMBER),
