...
1. Installez Python 3.7 ou plus depuis le site [https://www.python.org](https://www.python.org). Cochez bien l’option *Add Python 3.x to PATH* durant l’installation.
...
Utilisez les commandes suivantes pour vous placer dans le répertoire Teamworks et lancer l'application :
