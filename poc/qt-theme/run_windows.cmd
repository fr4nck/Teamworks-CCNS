...
".venv\Scripts\python.exe" -m py_compile app.py launcher.py theme_engine.py data_adapter.py domain_read_adapter.py production_read_adapter.py models.py pilot_view.py legacy_individual_tabs.py legacy_sheets.py legacy_contract_wizard.py generalities_satellites.py satellites_gallery.py contract_editor.py frugality.py || goto :error
