...
".venv\Scripts\python.exe" -m py_compile app.py launcher.py theme_engine.py data_adapter.py domain_read_adapter.py production_read_adapter.py models.py pilot_view.py frugality.py || goto :error
