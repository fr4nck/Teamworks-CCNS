...
".venv\Scripts\python.exe" -m py_compile "%REPO_ROOT%\infrastructure\persistence\person_reader.py" "%REPO_ROOT%\domain\repositories\person_data.py" "%REPO_ROOT%\infrastructure\persistence\individual_activity_reader.py" "%REPO_ROOT%\domain\repositories\individual_activity_data.py" || goto :error
