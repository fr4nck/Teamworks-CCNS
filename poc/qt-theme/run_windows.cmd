...
".venv\Scripts\python.exe" -m py_compile app.py launcher.py theme_engine.py data_adapter.py domain_read_adapter.py frugality.py || goto :error

echo [Teamworks Qt POC] Lancement du stress-test UI + mesure de frugalite...
