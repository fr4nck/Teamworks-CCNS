...
echo [Teamworks Qt benchmark] Smoke runtime asynchrone A vers B vers C sur plugin Windows natif...
set "TEAMWORKS_QT_NATIVE_WINDOWS_REQUIRED=1"
set "QT_QPA_PLATFORM="
".venv\Scripts\python.exe" runtime_async_smoke.py || goto :error
set "TEAMWORKS_QT_NATIVE_WINDOWS_REQUIRED="
