...
- CRH-01 à CRH-08 restent sans persistance ; CRH-09 introduit le store isolé des fondations, CRH-10A l'orchestration structure, CRH-11 le modèle salarié, CRH-12 son orchestration applicative, CRH-13 son adaptateur de référence, CRH-14 sa projection de consultation et CRH-15 le premier rendu wxPython découplé. Aucune authentification réelle, ouverture de navigateur effective ou communication réseau n'est ajoutée ;
