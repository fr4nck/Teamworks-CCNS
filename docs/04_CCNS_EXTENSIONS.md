...
- CRH-01 à CRH-08 restent sans persistance ; CRH-09 introduit uniquement le store isolé, CRH-10A l'orchestration structure et CRH-11 le modèle salarié. Aucune authentification réelle, ouverture de navigateur effective ou communication réseau n'est ajoutée ;
